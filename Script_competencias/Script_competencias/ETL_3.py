...
if "Ponderaciones sucursal" in wb.sheetnames:
    del wb["Ponderaciones sucursal"]
ws = wb.create_sheet("Ponderaciones sucursal")
...
CONFIG = {
    "Intra": {
        "CCH": "sucursal_y_aereo_correos_chile",
        "Starken": "sucursal_starken",
        "Blue": "sucursal_blue_express",
    ...
    "Lejos Terrestre": {
        "CCH": "terrestre_sucursal_correos_chile",
        "Starken": "sucursal_starken",
        "Blue": "sucursal_blue_express",
        "CH express": None
    }
